...
//! ## Identity
//!
//! Nodes are keyed by [`sphere_core::NodeId`], a generational handle. A handle to
...
use sphere_core::{Edges, GenerationalStore, LayoutError, NodeId, Point, Px, Rect, Size, size};
...
mod tests {
    ...
    fn max_scroll_never_goes_negative() {
        let layout = ComputedLayout {
            bounds: sphere_core::rect(px(0.0), px(0.0), px(100.0), px(100.0)),
            absolute_bounds: sphere_core::rect(px(0.0), px(0.0), px(100.0), px(100.0)),
    ...
    fn content_box_subtracts_border_and_padding_once() {
        let layout = ComputedLayout {
            bounds: sphere_core::rect(px(0.0), px(0.0), px(100.0), px(100.0)),
            absolute_bounds: sphere_core::rect(px(10.0), px(20.0), px(100.0), px(100.0)),
            border: Edges::all(px(2.0)),
            padding: Edges::all(px(5.0)),
            ..ComputedLayout::ZERO
        };
        assert_eq!(layout.padding_box(), sphere_core::rect(px(12.0), px(22.0), px(96.0), px(96.0)));
        assert_eq!(layout.content_box(), sphere_core::rect(px(17.0), px(27.0), px(86.0), px(86.0)));
    }
}
