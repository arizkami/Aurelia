...
//! [`SvgError::Unsupported`](sphere_core::SvgError::Unsupported) rather than
...
//!
//! ```no_run
//! use sphere_svg::SvgCache;
//! use sphere_core::{Color, px, rect};
//!
//! # fn demo(canvas: &mut sphere_render::Canvas<'_>) -> Result<(), sphere_core::SvgError> {
...
pub use sphere_core::{SvgError, SvgId};
