...
//!
//! WGSL has no `#include`, and every shader SphereKit ships needs the same
...
use spherekit_core::ShaderError;
...
mod tests {
    ...
    fn shader_flag_constants_match_the_rust_side() {
        ...
        for (name, value) in [
            ("FILL_SOLID", spherekit_render::quad_flags::FILL_SOLID),
            ("FILL_GRADIENT", spherekit_render::quad_flags::FILL_GRADIENT),
            ("FILL_TEXTURE", spherekit_render::quad_flags::FILL_TEXTURE),
            ("SHADOW", spherekit_render::quad_flags::SHADOW),
            ("SHADOW_INSET", spherekit_render::quad_flags::SHADOW_INSET),
            ("CLIP_ROUNDED", spherekit_render::quad_flags::CLIP_ROUNDED),
            ("BORDER", spherekit_render::quad_flags::BORDER),
        ] {
        ...
        for (name, value) in [
            ("BITMAP", spherekit_render::glyph_flags::BITMAP),
            ("OUTLINE", spherekit_render::glyph_flags::OUTLINE),
            ("CLIP_ROUNDED", spherekit_render::glyph_flags::CLIP_ROUNDED),
            ("SUBPIXEL", spherekit_render::glyph_flags::SUBPIXEL),
        ] {
            let needle = format!("const {name}: u32 = {value}u;");
    ...
    fn gradient_stop_count_matches_the_rust_side() {
        ...
        let needle =
            format!("const MAX_GRADIENT_STOPS: u32 = {}u;", spherekit_render::MAX_GRADIENT_STOPS);
