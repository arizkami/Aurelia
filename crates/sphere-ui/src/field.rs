...
use sphere_core::{Color, Corners, ElementId, Point, Px, Rect, Size, px, relative};
use sphere_layout::Style;
use sphere_render::TextRasterMode;
use sphere_text::{TextLayout, TextStyle, TextSystem, WrapMode};
...
impl Element for TextField {
    ...
    fn layout_style(&self) -> Style {
        ...
        if matches!(style.size.height, sphere_core::Length::Auto) {
            style.size.height = sphere_core::Length::Px(px(HEIGHT));
        }
