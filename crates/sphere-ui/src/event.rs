...
//!
//! Platform events arrive as `sphere_platform::WindowEvent`. This module turns
...
use sphere_core::{ElementId, NodeId, Point, Px, Size};
...
pub enum Key {
    ...
    Function(u8),
    /// A key with no Sphere-level meaning, identified by its platform code.
    Unidentified(u32),
}
...
pub struct HitTarget {
    ...
    pub bounds: sphere_core::Rect<Px>,
}
...
impl ClickTracker {
    ...
    pub fn press(&mut self, button: MouseButton, position: Point<Px>, time_ms: u64) -> u8 {
        ...
        self.count = if in_time && in_place && same_button && self.count > 0 {
            ...
            // interface Sphere targets, and wrapping a u8 would be worse.
