//! # spherekit-core
//!
//! The shared vocabulary of `SphereKit`: units, geometry, transforms,
//! color, paths, paint, identity and errors.
//!
//! This crate has no GPU, windowing or text dependencies. Every other SphereKit
...
//! ## Units
//!
//! SphereKit is strict about the difference between logical and physical pixels.
...
//!
//! ```
//! use spherekit_core::{px, ScaleFactor, DevicePx};
//!
