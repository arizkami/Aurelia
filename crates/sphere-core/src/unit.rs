...
//!
//! Sphere separates *logical* pixels ([`Px`]) from *physical device* pixels
...
float_unit! {
    /// A logical pixel: the unit every public Sphere API speaks.
    ///
...
///
/// Fractional values (1.25, 1.5, 1.75) are first-class; nothing in Sphere
...
///
/// This is the authoring-side length used by Sphere consumers; the layout crate
