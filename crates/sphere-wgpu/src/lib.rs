//! # sphere-wgpu
//!
//! The wgpu rendering backend for SphereGraphicEngine.
//!
//! This is the only crate in the workspace that knows wgpu exists. It
//! implements [`sphere_render::RendererBackend`], consuming the pure-data
//! [`sphere_render::CompiledFrame`] the batch compiler produces.
//!
//! ## Backend mapping
//!
//! | Platform | API |
...
//! Everything Sphere hands the GPU is linear and premultiplied, which is what
