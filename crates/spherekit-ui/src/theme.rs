...
use spherekit_core::{Color, Px, Shadow, Size};
...
pub struct Typography {
    ...
    pub weight: spherekit_text::FontWeight,
    ...
    fn shared() -> Self {
        Self {
            ...
            typography: Typography {
                ...
                xl: Px(20.0),
                line_height: 1.35,
                weight: spherekit_text::FontWeight::NORMAL,
                strong: spherekit_text::FontWeight::SEMI_BOLD,
            },
