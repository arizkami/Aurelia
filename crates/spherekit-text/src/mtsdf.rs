...
//! C++ and SphereKit is pure Rust, so the algorithm is reproduced here rather than
//! bound to.
//!
...
//!
//! TrueType and CFF outlines are y-**up** and measured in font units. SphereKit is
...
use spherekit_core::{Edges, FontError, GlyphId, Point, Rect, Size};
...
impl OutlineCollector {
    ...
    /// Font units to em units, flipping y: font space is y-up, SphereKit is y-down.
    #[inline]
...
pub fn face_metrics(face: &ttf_parser::Face<'_>) -> FontMetrics {
    ...
    FontMetrics {
        ...
        // SphereKit measures it positive-down.
