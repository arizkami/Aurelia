...
//!
//! winit has no clipboard API — it deliberately stops at windowing — so SphereKit
...
//!   support and with it the whole `image` crate: SphereKit only needs text here.
...
use spherekit_core::PlatformError;
