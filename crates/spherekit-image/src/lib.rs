//! # spherekit-image
//!
//! Image decoding, caching and texture preparation for `SphereKit`.
//!
...
//!
//! ```no_run
//! use spherekit_core::{px, rect};
//! use spherekit_image::{ImageCache, ImageFit, resolve_fit};
//!
...
// Re-exported so consumers do not need a direct `spherekit-core` dependency just to
// name the types this crate's signatures speak in.
pub use spherekit_core::{ImageError, ImageFit, ImageId, TextureId};
