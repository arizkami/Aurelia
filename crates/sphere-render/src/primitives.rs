...
use sphere_core::{Affine, Corners, LinearColor, Px, Rect, ScaleFactor};
...
impl GpuGradient {
    ...
    pub fn from_gradient(g: &sphere_core::Gradient) -> Self {
        use sphere_core::Gradient;
...
mod tests {
    ...
    use sphere_core::{Color, Gradient, GradientStop, Point, Size, px, rect};
